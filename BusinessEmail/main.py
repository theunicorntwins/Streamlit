...
st.set_page_config(page_title="Business Email", page_icon=":robot:")
st.header("Business Email")
...
openai_api_key = st.text_input(label="Please enter the OPEN_API_KEY: ", placeholder="Ex: sk-2twmA8tfCb8un4...")
...
def update_text_with_example():
    print("in updated")
    st.session_state.email_input = "Hi Kayla I am starts work at yours monday from Mr.Do"
